...
internal class hkbTransitionEffectData : HavokData<hkbTransitionEffect>
{
    public hkbTransitionEffectData(HavokType type, hkbTransitionEffect instance) : base(type, instance) { }
