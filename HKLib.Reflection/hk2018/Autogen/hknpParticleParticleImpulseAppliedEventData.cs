...
internal class hknpParticleParticleImpulseAppliedEventData : HavokData<hknpParticleParticleImpulseAppliedEvent>
{
    public hknpParticleParticleImpulseAppliedEventData(HavokType type, hknpParticleParticleImpulseAppliedEvent instance) : base(type, instance) { }
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "contact":
                {
                    if (value is not hknpParticleParticleContact castValue) return false;
