...
internal class hclObjectSpaceMeshMeshDeformPNTBOperatorData : HavokData<hclObjectSpaceMeshMeshDeformPNTBOperator>
{
    public hclObjectSpaceMeshMeshDeformPNTBOperatorData(HavokType type, hclObjectSpaceMeshMeshDeformPNTBOperator instance) : base(type, instance) { }
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "localPNTBs":
                {
                    if (value is not List<hclObjectSpaceDeformer.LocalBlockPNTB> castValue) return false;
            ...
            case "localUnpackedPNTBs":
                {
                    if (value is not List<hclObjectSpaceDeformer.LocalBlockUnpackedPNTB> castValue) return false;
