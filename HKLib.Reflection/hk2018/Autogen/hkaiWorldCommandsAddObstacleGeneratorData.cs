...
internal class hkaiWorldCommandsAddObstacleGeneratorData : HavokData<AddObstacleGenerator>
{
    public hkaiWorldCommandsAddObstacleGeneratorData(HavokType type, AddObstacleGenerator instance) : base(type, instance) { }
