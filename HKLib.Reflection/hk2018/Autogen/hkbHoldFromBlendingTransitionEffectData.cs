...
internal class hkbHoldFromBlendingTransitionEffectData : HavokData<hkbHoldFromBlendingTransitionEffect>
{
    public hkbHoldFromBlendingTransitionEffectData(HavokType type, hkbHoldFromBlendingTransitionEffect instance) : base(type, instance) { }
