...
internal class hkpDeformableLinConstraintAtomData : HavokData<hkpDeformableLinConstraintAtom>
{
    public hkpDeformableLinConstraintAtomData(HavokType type, hkpDeformableLinConstraintAtom instance) : base(type, instance) { }
