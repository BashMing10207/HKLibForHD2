...
internal class hknpParticlesExitedBroadPhaseEventData : HavokData<hknpParticlesExitedBroadPhaseEvent>
{
    public hknpParticlesExitedBroadPhaseEventData(HavokType type, hknpParticlesExitedBroadPhaseEvent instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_particleIndices":
            case "particleIndices":
                {
                    if (instance.m_particleIndices is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
            ...
            case "particleIndices":
                {
                    ...
                    instance.m_particleIndices = castValue;
                    return true;
                }
            default:
                return false;
