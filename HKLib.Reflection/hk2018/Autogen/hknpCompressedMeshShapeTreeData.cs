...
internal class hknpCompressedMeshShapeTreeData : HavokData<hknpCompressedMeshShapeTree>
{
    public hknpCompressedMeshShapeTreeData(HavokType type, hknpCompressedMeshShapeTree instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_packedVertices":
            case "packedVertices":
                {
                    if (instance.m_packedVertices is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_sharedVertices":
            case "sharedVertices":
                {
                    if (instance.m_sharedVertices is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_primitiveDataRuns":
            case "primitiveDataRuns":
                {
                    if (instance.m_primitiveDataRuns is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
            ...
            case "packedVertices":
                {
                    ...
                    instance.m_packedVertices = castValue;
                    return true;
                }
            case "m_sharedVertices":
            case "sharedVertices":
                {
                    ...
                    instance.m_sharedVertices = castValue;
                    return true;
                }
            case "m_primitiveDataRuns":
            case "primitiveDataRuns":
                {
                    if (value is not List<hkcdDefaultStaticMeshTree.PrimitiveDataRun> castValue) return false;
                    instance.m_primitiveDataRuns = castValue;
                    return true;
                }
            default:
                return false;
