...
internal class hkaiWorldCommandsVolumeNavigatorSetAcceptablePathQualitiesData : HavokData<VolumeNavigatorSetAcceptablePathQualities>
{
    public hkaiWorldCommandsVolumeNavigatorSetAcceptablePathQualitiesData(HavokType type, VolumeNavigatorSetAcceptablePathQualities instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "acceptablePathQualities":
                {
                    if (instance.m_acceptablePathQualities is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
