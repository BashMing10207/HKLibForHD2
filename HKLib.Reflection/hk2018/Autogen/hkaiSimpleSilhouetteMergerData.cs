...
internal class hkaiSimpleSilhouetteMergerData : HavokData<hkaiSimpleSilhouetteMerger>
{
    public hkaiSimpleSilhouetteMergerData(HavokType type, hkaiSimpleSilhouetteMerger instance) : base(type, instance) { }
