...
internal class hkaiWorldCommandsStepSingleThreadedData : HavokData<StepSingleThreaded>
{
    public hkaiWorldCommandsStepSingleThreadedData(HavokType type, StepSingleThreaded instance) : base(type, instance) { }
