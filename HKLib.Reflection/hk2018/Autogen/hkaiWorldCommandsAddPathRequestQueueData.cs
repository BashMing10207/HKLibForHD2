...
internal class hkaiWorldCommandsAddPathRequestQueueData : HavokData<AddPathRequestQueue>
{
    public hkaiWorldCommandsAddPathRequestQueueData(HavokType type, AddPathRequestQueue instance) : base(type, instance) { }
