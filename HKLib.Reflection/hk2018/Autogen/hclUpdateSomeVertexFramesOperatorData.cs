...
internal class hclUpdateSomeVertexFramesOperatorData : HavokData<hclUpdateSomeVertexFramesOperator>
{
    public hclUpdateSomeVertexFramesOperatorData(HavokType type, hclUpdateSomeVertexFramesOperator instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_involvedTriangles":
            case "involvedTriangles":
                {
                    if (instance.m_involvedTriangles is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_involvedVertices":
            case "involvedVertices":
                {
                    if (instance.m_involvedVertices is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_selectionVertexToInvolvedVertex":
            case "selectionVertexToInvolvedVertex":
                {
                    if (instance.m_selectionVertexToInvolvedVertex is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_involvedVertexToNormalID":
            case "involvedVertexToNormalID":
                {
                    if (instance.m_involvedVertexToNormalID is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "involvedTriangles":
                {
                    if (value is not List<hclUpdateSomeVertexFramesOperator.Triangle> castValue) return false;
                    instance.m_involvedTriangles = castValue;
                    return true;
                }
            case "m_involvedVertices":
            case "involvedVertices":
                {
                    ...
                    instance.m_involvedVertices = castValue;
                    return true;
                }
            case "m_selectionVertexToInvolvedVertex":
            case "selectionVertexToInvolvedVertex":
                {
                    if (value is not List<ushort> castValue) return false;
                    instance.m_selectionVertexToInvolvedVertex = castValue;
                    return true;
                }
            case "m_involvedVertexToNormalID":
            case "involvedVertexToNormalID":
                {
                    if (value is not List<ushort> castValue) return false;
                    instance.m_involvedVertexToNormalID = castValue;
                    return true;
                }
            case "m_triangleFlips":
            case "triangleFlips":
