...
internal class hkcdStaticTreeAabb6BytesTreeData : HavokData<Aabb6BytesTree>
{
    public hkcdStaticTreeAabb6BytesTreeData(HavokType type, Aabb6BytesTree instance) : base(type, instance) { }
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "nodes":
                {
                    if (value is not List<Aabb6BytesCodec> castValue) return false;
