...
internal class hknpReintegrateMotionCommandData : HavokData<hknpReintegrateMotionCommand>
{
    public hknpReintegrateMotionCommandData(HavokType type, hknpReintegrateMotionCommand instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "t":
                {
                    if (instance.m_t is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
