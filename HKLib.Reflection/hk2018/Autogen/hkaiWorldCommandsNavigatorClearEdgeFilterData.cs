...
internal class hkaiWorldCommandsNavigatorClearEdgeFilterData : HavokData<NavigatorClearEdgeFilter>
{
    public hkaiWorldCommandsNavigatorClearEdgeFilterData(HavokType type, NavigatorClearEdgeFilter instance) : base(type, instance) { }
