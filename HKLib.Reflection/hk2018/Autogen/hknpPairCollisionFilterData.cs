...
internal class hknpPairCollisionFilterData : HavokData<hknpPairCollisionFilter>
{
    public hknpPairCollisionFilterData(HavokType type, hknpPairCollisionFilter instance) : base(type, instance) { }
