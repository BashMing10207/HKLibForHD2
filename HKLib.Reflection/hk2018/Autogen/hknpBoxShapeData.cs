...
internal class hknpBoxShapeData : HavokData<hknpBoxShape>
{
    public hknpBoxShapeData(HavokType type, hknpBoxShape instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "obb":
                {
                    if (instance.m_obb is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
