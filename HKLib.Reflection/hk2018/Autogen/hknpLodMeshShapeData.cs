...
internal class hknpLodMeshShapeData : HavokData<hknpLodMeshShape>
{
    private static readonly System.Reflection.FieldInfo _variantsInfo = typeof(hknpLodMeshShape).GetField("m_variants")!;
    private static readonly System.Reflection.FieldInfo _lodTypeToVariantInfo = typeof(hknpLodMeshShape).GetField("m_lodTypeToVariant")!;
    private static readonly System.Reflection.FieldInfo _infosInfo = typeof(hknpLodMeshShape).GetField("m_infos")!;
    public hknpLodMeshShapeData(HavokType type, hknpLodMeshShape instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "infos":
                {
                    if (instance.m_infos is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_maximumAabb":
            case "maximumAabb":
                {
                    if (instance.m_maximumAabb is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "infos":
                {
                    if (value is not hknpLodMeshShape.LevelOfDetailInfo[] castValue || castValue.Length != 8) return false;
                    try
                    {
                        _infosInfo.SetValue(instance, value);
                        return true;
                    }
                    catch
                    {
            ...
            case "maximumAabb":
                {
                    ...
                    instance.m_maximumAabb = castValue;
                    return true;
                }
            default:
                return false;
