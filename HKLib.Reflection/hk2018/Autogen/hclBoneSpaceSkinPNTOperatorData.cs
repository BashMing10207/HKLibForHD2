...
internal class hclBoneSpaceSkinPNTOperatorData : HavokData<hclBoneSpaceSkinPNTOperator>
{
    public hclBoneSpaceSkinPNTOperatorData(HavokType type, hclBoneSpaceSkinPNTOperator instance) : base(type, instance) { }
