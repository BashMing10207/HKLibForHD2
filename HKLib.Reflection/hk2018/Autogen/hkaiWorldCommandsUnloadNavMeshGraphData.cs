...
internal class hkaiWorldCommandsUnloadNavMeshGraphData : HavokData<UnloadNavMeshGraph>
{
    public hkaiWorldCommandsUnloadNavMeshGraphData(HavokType type, UnloadNavMeshGraph instance) : base(type, instance) { }
