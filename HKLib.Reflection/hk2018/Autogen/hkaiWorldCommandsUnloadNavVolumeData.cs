...
internal class hkaiWorldCommandsUnloadNavVolumeData : HavokData<UnloadNavVolume>
{
    public hkaiWorldCommandsUnloadNavVolumeData(HavokType type, UnloadNavVolume instance) : base(type, instance) { }
