...
internal class hkbCustomTestGeneratorData : HavokData<hkbCustomTestGenerator>
{
    public hkbCustomTestGeneratorData(HavokType type, hkbCustomTestGenerator instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_protectedHiddenMember":
            case "protectedHiddenMember":
                {
                    if (instance.m_protectedHiddenMember is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_privateHiddenMember":
            case "privateHiddenMember":
                {
                    if (instance.m_privateHiddenMember is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "protectedHiddenMember":
                {
                    if (value is not bool castValue) return false;
                    instance.m_protectedHiddenMember = castValue;
                    return true;
                }
            case "m_privateHiddenMember":
            case "privateHiddenMember":
                {
                    if (value is not bool castValue) return false;
                    instance.m_privateHiddenMember = castValue;
                    return true;
                }
            default:
                return false;
