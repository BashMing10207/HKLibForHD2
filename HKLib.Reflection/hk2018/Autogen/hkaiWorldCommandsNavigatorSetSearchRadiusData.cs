...
internal class hkaiWorldCommandsNavigatorSetSearchRadiusData : HavokData<NavigatorSetSearchRadius>
{
    public hkaiWorldCommandsNavigatorSetSearchRadiusData(HavokType type, NavigatorSetSearchRadius instance) : base(type, instance) { }
