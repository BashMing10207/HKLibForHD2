...
internal class hkaiWorldCommandsNavigatorSetHeuristicWeightData : HavokData<NavigatorSetHeuristicWeight>
{
    public hkaiWorldCommandsNavigatorSetHeuristicWeightData(HavokType type, NavigatorSetHeuristicWeight instance) : base(type, instance) { }
