...
internal class hknpStepAllParticlesCollidersTraceData : HavokData<hknpStepAllParticlesCollidersTrace>
{
    public hknpStepAllParticlesCollidersTraceData(HavokType type, hknpStepAllParticlesCollidersTrace instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "stepInput":
                {
                    if (instance.m_stepInput is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "stepInput":
                {
                    if (value is not hknpStepInput castValue) return false;
                    instance.m_stepInput = castValue;
                    return true;
                }
            default:
                return false;
