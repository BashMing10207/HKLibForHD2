...
internal class hknpCommitAddBodiesCommandData : HavokData<hknpCommitAddBodiesCommand>
{
    public hknpCommitAddBodiesCommandData(HavokType type, hknpCommitAddBodiesCommand instance) : base(type, instance) { }
