...
internal class hkaiWorldCommandsVolumeNavigatorAddData : HavokData<VolumeNavigatorAdd>
{
    public hkaiWorldCommandsVolumeNavigatorAddData(HavokType type, VolumeNavigatorAdd instance) : base(type, instance) { }
