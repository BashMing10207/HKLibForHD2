...
internal class hkaiWorldCommandsNavigatorSetFilterInfoData : HavokData<NavigatorSetFilterInfo>
{
    public hkaiWorldCommandsNavigatorSetFilterInfoData(HavokType type, NavigatorSetFilterInfo instance) : base(type, instance) { }
