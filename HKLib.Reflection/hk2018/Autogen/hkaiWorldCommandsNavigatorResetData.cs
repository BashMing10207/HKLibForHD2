...
internal class hkaiWorldCommandsNavigatorResetData : HavokData<NavigatorReset>
{
    public hkaiWorldCommandsNavigatorResetData(HavokType type, NavigatorReset instance) : base(type, instance) { }
