...
using Enum = HKLib.hk2018.hknpActivationState.Enum;

namespace HKLib.Reflection.hk2018;

internal class hknpSetBodyActivationStateCommandData : HavokData<hknpSetBodyActivationStateCommand>
{
    public hknpSetBodyActivationStateCommandData(HavokType type, hknpSetBodyActivationStateCommand instance) : base(type, instance) { }
            ...
            case "state":
                {
                    ...
                    if ((byte)instance.m_state is TGet byteValue)
                    {
                        value = byteValue;
                        return true;
                    }
            ...
            case "state":
                {
                    ...
                    if (value is byte byteValue)
                    {
                        instance.m_state = (Enum)byteValue;
                        return true;
                    }
                    return false;
                }
