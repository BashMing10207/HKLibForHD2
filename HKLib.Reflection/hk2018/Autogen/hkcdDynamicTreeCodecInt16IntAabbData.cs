...
internal class hkcdDynamicTreeCodecInt16IntAabbData : HavokData<CodecInt16.IntAabb>
{
    private static readonly System.Reflection.FieldInfo _minInfo = typeof(CodecInt16.IntAabb).GetField("m_min")!;
    private static readonly System.Reflection.FieldInfo _maxInfo = typeof(CodecInt16.IntAabb).GetField("m_max")!;
    public hkcdDynamicTreeCodecInt16IntAabbData(HavokType type, CodecInt16.IntAabb instance) : base(type, instance) { }
