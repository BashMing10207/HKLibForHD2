...
internal class hclBoneSpaceSkinOperatorData : HavokData<hclBoneSpaceSkinOperator>
{
    public hclBoneSpaceSkinOperatorData(HavokType type, hclBoneSpaceSkinOperator instance) : base(type, instance) { }
