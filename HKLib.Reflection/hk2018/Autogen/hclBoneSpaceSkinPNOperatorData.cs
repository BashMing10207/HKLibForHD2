...
internal class hclBoneSpaceSkinPNOperatorData : HavokData<hclBoneSpaceSkinPNOperator>
{
    public hclBoneSpaceSkinPNOperatorData(HavokType type, hclBoneSpaceSkinPNOperator instance) : base(type, instance) { }
