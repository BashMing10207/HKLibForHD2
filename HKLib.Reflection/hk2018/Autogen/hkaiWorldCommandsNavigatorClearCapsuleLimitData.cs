...
internal class hkaiWorldCommandsNavigatorClearCapsuleLimitData : HavokData<NavigatorClearCapsuleLimit>
{
    public hkaiWorldCommandsNavigatorClearCapsuleLimitData(HavokType type, NavigatorClearCapsuleLimit instance) : base(type, instance) { }
