...
internal class hkaiWorldCommandsNavigatorSetIterationLimitData : HavokData<NavigatorSetIterationLimit>
{
    public hkaiWorldCommandsNavigatorSetIterationLimitData(HavokType type, NavigatorSetIterationLimit instance) : base(type, instance) { }
