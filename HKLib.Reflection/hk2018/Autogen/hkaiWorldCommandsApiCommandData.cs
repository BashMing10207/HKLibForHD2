...
internal class hkaiWorldCommandsApiCommandData : HavokData<ApiCommand>
{
    public hkaiWorldCommandsApiCommandData(HavokType type, ApiCommand instance) : base(type, instance) { }
