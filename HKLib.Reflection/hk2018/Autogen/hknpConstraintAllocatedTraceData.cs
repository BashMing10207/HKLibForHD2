...
internal class hknpConstraintAllocatedTraceData : HavokData<hknpConstraintAllocatedTrace>
{
    public hknpConstraintAllocatedTraceData(HavokType type, hknpConstraintAllocatedTrace instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_constraintCinfo":
            case "constraintCinfo":
                {
                    if (instance.m_constraintCinfo is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "constraintCinfo":
                {
                    if (value is not hknpConstraintCinfo castValue) return false;
                    instance.m_constraintCinfo = castValue;
                    return true;
                }
            case "m_activationMode":
            case "activationMode":
