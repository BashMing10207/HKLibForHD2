...
internal class hknpConvexPolytopeShapeData : HavokData<hknpConvexPolytopeShape>
{
    public hknpConvexPolytopeShapeData(HavokType type, hknpConvexPolytopeShape instance) : base(type, instance) { }
