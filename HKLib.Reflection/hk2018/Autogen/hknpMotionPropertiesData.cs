...
internal class hknpMotionPropertiesData : HavokData<hknpMotionProperties>
{
    public hknpMotionPropertiesData(HavokType type, hknpMotionProperties instance) : base(type, instance) { }
