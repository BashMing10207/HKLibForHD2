...
internal class hclObjectSpaceSkinPNTBOperatorData : HavokData<hclObjectSpaceSkinPNTBOperator>
{
    public hclObjectSpaceSkinPNTBOperatorData(HavokType type, hclObjectSpaceSkinPNTBOperator instance) : base(type, instance) { }
