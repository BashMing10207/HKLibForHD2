...
internal class hkbMoveCharacterModifierData : HavokData<hkbMoveCharacterModifier>
{
    public hkbMoveCharacterModifierData(HavokType type, hkbMoveCharacterModifier instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_offsetPerSecondMS":
            case "offsetPerSecondMS":
                {
                    if (instance.m_offsetPerSecondMS is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
            ...
            case "offsetPerSecondMS":
                {
                    ...
                    instance.m_offsetPerSecondMS = castValue;
                    return true;
                }
            default:
                return false;
