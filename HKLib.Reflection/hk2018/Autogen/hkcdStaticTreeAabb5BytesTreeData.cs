...
internal class hkcdStaticTreeAabb5BytesTreeData : HavokData<Aabb5BytesTree>
{
    public hkcdStaticTreeAabb5BytesTreeData(HavokType type, Aabb5BytesTree instance) : base(type, instance) { }
