...
internal class hknpRemoveBodyCommandData : HavokData<hknpRemoveBodyCommand>
{
    public hknpRemoveBodyCommandData(HavokType type, hknpRemoveBodyCommand instance) : base(type, instance) { }
