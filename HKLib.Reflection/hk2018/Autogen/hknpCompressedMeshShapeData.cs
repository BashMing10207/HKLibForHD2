...
internal class hknpCompressedMeshShapeData : HavokData<hknpCompressedMeshShape>
{
    public hknpCompressedMeshShapeData(HavokType type, hknpCompressedMeshShape instance) : base(type, instance) { }
