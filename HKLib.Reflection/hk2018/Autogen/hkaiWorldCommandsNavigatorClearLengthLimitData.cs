...
internal class hkaiWorldCommandsNavigatorClearLengthLimitData : HavokData<NavigatorClearLengthLimit>
{
    public hkaiWorldCommandsNavigatorClearLengthLimitData(HavokType type, NavigatorClearLengthLimit instance) : base(type, instance) { }
