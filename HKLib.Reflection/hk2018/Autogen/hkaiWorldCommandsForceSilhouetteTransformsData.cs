...
internal class hkaiWorldCommandsForceSilhouetteTransformsData : HavokData<ForceSilhouetteTransforms>
{
    public hkaiWorldCommandsForceSilhouetteTransformsData(HavokType type, ForceSilhouetteTransforms instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "transforms":
                {
                    if (instance.m_transforms is null)
                    {
                        return true;
                    }
                    if (instance.m_transforms is TGet castValue)
                    {
                        value = castValue;
                        return true;
                    }
            ...
            case "transforms":
                {
                    if (value is null)
                    {
                        instance.m_transforms = default;
                        return true;
                    }
                    if (value is hkaiReferencedArray<hkQTransform> castValue)
                    {
