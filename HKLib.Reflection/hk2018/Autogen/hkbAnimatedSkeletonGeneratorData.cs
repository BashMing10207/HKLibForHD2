...
internal class hkbAnimatedSkeletonGeneratorData : HavokData<hkbAnimatedSkeletonGenerator>
{
    public hkbAnimatedSkeletonGeneratorData(HavokType type, hkbAnimatedSkeletonGenerator instance) : base(type, instance) { }
