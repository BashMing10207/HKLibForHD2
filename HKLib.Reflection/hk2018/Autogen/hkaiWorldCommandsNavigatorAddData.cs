...
internal class hkaiWorldCommandsNavigatorAddData : HavokData<NavigatorAdd>
{
    public hkaiWorldCommandsNavigatorAddData(HavokType type, NavigatorAdd instance) : base(type, instance) { }
