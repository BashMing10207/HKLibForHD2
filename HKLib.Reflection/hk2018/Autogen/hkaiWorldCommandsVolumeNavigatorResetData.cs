...
internal class hkaiWorldCommandsVolumeNavigatorResetData : HavokData<VolumeNavigatorReset>
{
    public hkaiWorldCommandsVolumeNavigatorResetData(HavokType type, VolumeNavigatorReset instance) : base(type, instance) { }
