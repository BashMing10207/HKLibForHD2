...
internal class hknpStepSolveTraceData : HavokData<hknpStepSolveTrace>
{
    public hknpStepSolveTraceData(HavokType type, hknpStepSolveTrace instance) : base(type, instance) { }
