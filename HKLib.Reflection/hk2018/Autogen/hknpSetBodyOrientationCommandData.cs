...
internal class hknpSetBodyOrientationCommandData : HavokData<hknpSetBodyOrientationCommand>
{
    public hknpSetBodyOrientationCommandData(HavokType type, hknpSetBodyOrientationCommand instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "pivot":
                {
                    if (instance.m_pivot is TGet castValue)
                    {
                        value = castValue;
                        return true;
                    }
                    if ((byte)instance.m_pivot is TGet byteValue)
                    {
                        value = byteValue;
                        return true;
                    }
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "pivot":
                {
                    if (value is PivotLocation castValue)
                    {
                    ...
                    if (value is byte byteValue)
                    {
                        instance.m_pivot = (PivotLocation)byteValue;
                        return true;
                    }
                    return false;
                }
