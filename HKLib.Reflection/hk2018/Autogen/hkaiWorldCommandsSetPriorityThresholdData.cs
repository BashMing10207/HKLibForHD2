...
internal class hkaiWorldCommandsSetPriorityThresholdData : HavokData<SetPriorityThreshold>
{
    public hkaiWorldCommandsSetPriorityThresholdData(HavokType type, SetPriorityThreshold instance) : base(type, instance) { }
