...
internal class hknpHeightFieldShapeData : HavokData<hknpHeightFieldShape>
{
    public hknpHeightFieldShapeData(HavokType type, hknpHeightFieldShape instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "boundingVolumeData":
                {
                    if (instance.m_boundingVolumeData is null)
                    {
                        return true;
                    }
                    if (instance.m_boundingVolumeData is TGet castValue)
                    {
                        value = castValue;
                        return true;
                    }
            ...
            case "intSizeX":
                {
                    if (instance.m_intSizeX is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_intSizeZ":
            case "intSizeZ":
                {
                    if (instance.m_intSizeZ is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_numBitsX":
            case "numBitsX":
                {
                    if (instance.m_numBitsX is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_numBitsZ":
            case "numBitsZ":
                {
                    if (instance.m_numBitsZ is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_includeShapeKeyInSdfContacts":
            case "includeShapeKeyInSdfContacts":
                {
                    if (instance.m_includeShapeKeyInSdfContacts is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_floatToIntScale":
            case "floatToIntScale":
                {
                    if (instance.m_floatToIntScale is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_intToFloatScale":
            case "intToFloatScale":
                {
                    if (instance.m_intToFloatScale is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_aabb":
            ...
            case "geometry":
                {
                    ...
                    if (value is hknpHeightFieldGeometry castValue)
                    {
            ...
            case "boundingVolumeData":
                {
                    if (value is null)
                    {
                        instance.m_boundingVolumeData = default;
                        return true;
                    }
                    if (value is hknpHeightFieldBoundingVolume castValue)
                    {
            ...
            case "includeShapeKeyInSdfContacts":
                {
                    ...
                    instance.m_includeShapeKeyInSdfContacts = castValue;
                    return true;
                }
            case "m_floatToIntScale":
            case "floatToIntScale":
                {
                    ...
                    instance.m_floatToIntScale = castValue;
                    return true;
                }
            case "m_intToFloatScale":
            case "intToFloatScale":
                {
                    if (value is not Vector4 castValue) return false;
                    instance.m_intToFloatScale = castValue;
                    return true;
                }
            case "m_aabb":
            case "aabb":
