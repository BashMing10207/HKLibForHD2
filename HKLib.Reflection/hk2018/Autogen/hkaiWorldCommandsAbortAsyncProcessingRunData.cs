...
internal class hkaiWorldCommandsAbortAsyncProcessingRunData : HavokData<AbortAsyncProcessingRun>
{
    public hkaiWorldCommandsAbortAsyncProcessingRunData(HavokType type, AbortAsyncProcessingRun instance) : base(type, instance) { }
