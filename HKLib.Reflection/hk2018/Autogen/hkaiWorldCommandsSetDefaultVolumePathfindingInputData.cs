...
internal class hkaiWorldCommandsSetDefaultVolumePathfindingInputData : HavokData<SetDefaultVolumePathfindingInput>
{
    public hkaiWorldCommandsSetDefaultVolumePathfindingInputData(HavokType type, SetDefaultVolumePathfindingInput instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "input":
                {
                    if (instance.m_input is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
