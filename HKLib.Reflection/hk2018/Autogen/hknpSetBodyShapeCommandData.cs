...
internal class hknpSetBodyShapeCommandData : HavokData<hknpSetBodyShapeCommand>
{
    public hknpSetBodyShapeCommandData(HavokType type, hknpSetBodyShapeCommand instance) : base(type, instance) { }
