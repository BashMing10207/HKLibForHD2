...
internal class hkaiWorldCommandsShiftWorldSpaceData : HavokData<ShiftWorldSpace>
{
    public hkaiWorldCommandsShiftWorldSpaceData(HavokType type, ShiftWorldSpace instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "shift":
                {
                    if (instance.m_shift is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
