...
internal class hkaiWorldCommandsNavigatorSetCostModifierData : HavokData<NavigatorSetCostModifier>
{
    public hkaiWorldCommandsNavigatorSetCostModifierData(HavokType type, NavigatorSetCostModifier instance) : base(type, instance) { }
