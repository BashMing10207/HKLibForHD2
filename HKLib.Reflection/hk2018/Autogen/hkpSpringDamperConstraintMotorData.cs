...
internal class hkpSpringDamperConstraintMotorData : HavokData<hkpSpringDamperConstraintMotor>
{
    public hkpSpringDamperConstraintMotorData(HavokType type, hkpSpringDamperConstraintMotor instance) : base(type, instance) { }
