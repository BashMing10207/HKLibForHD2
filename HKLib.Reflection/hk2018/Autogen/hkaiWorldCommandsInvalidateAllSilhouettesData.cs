...
internal class hkaiWorldCommandsInvalidateAllSilhouettesData : HavokData<InvalidateAllSilhouettes>
{
    public hkaiWorldCommandsInvalidateAllSilhouettesData(HavokType type, InvalidateAllSilhouettes instance) : base(type, instance) { }
