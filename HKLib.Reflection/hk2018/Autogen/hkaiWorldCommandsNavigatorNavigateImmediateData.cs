...
internal class hkaiWorldCommandsNavigatorNavigateImmediateData : HavokData<NavigatorNavigateImmediate>
{
    public hkaiWorldCommandsNavigatorNavigateImmediateData(HavokType type, NavigatorNavigateImmediate instance) : base(type, instance) { }
