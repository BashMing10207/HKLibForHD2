...
internal class hknpApplyPointImpulseCommandData : HavokData<hknpApplyPointImpulseCommand>
{
    public hknpApplyPointImpulseCommandData(HavokType type, hknpApplyPointImpulseCommand instance) : base(type, instance) { }
