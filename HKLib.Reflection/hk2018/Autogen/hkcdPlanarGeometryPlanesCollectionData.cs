...
internal class hkcdPlanarGeometryPlanesCollectionData : HavokData<hkcdPlanarGeometryPlanesCollection>
{
    public hkcdPlanarGeometryPlanesCollectionData(HavokType type, hkcdPlanarGeometryPlanesCollection instance) : base(type, instance) { }
