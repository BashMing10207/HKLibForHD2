...
internal class hknpSetBodyPositionCommandData : HavokData<hknpSetBodyPositionCommand>
{
    public hknpSetBodyPositionCommandData(HavokType type, hknpSetBodyPositionCommand instance) : base(type, instance) { }
