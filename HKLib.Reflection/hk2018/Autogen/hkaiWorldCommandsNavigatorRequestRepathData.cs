...
internal class hkaiWorldCommandsNavigatorRequestRepathData : HavokData<NavigatorRequestRepath>
{
    public hkaiWorldCommandsNavigatorRequestRepathData(HavokType type, NavigatorRequestRepath instance) : base(type, instance) { }
