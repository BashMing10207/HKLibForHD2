...
internal class hkaiWorldCommandsForceSectionReferenceFramesData : HavokData<ForceSectionReferenceFrames>
{
    public hkaiWorldCommandsForceSectionReferenceFramesData(HavokType type, ForceSectionReferenceFrames instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_referenceFrames":
            case "referenceFrames":
                {
                    if (instance.m_referenceFrames is null)
                    {
                        return true;
                    }
                    if (instance.m_referenceFrames is TGet castValue)
                    {
                        value = castValue;
                        return true;
                    }
            ...
            case "referenceFrames":
                {
                    if (value is null)
                    {
                        instance.m_referenceFrames = default;
                        return true;
                    }
                    if (value is hkaiReferencedArray<hkaiReferenceFrame> castValue)
                    {
                        instance.m_referenceFrames = castValue;
                        return true;
                    }
                    return false;
                }
