...
internal class hkaiWorldCommandsStartAsyncProcessingRunData : HavokData<StartAsyncProcessingRun>
{
    public hkaiWorldCommandsStartAsyncProcessingRunData(HavokType type, StartAsyncProcessingRun instance) : base(type, instance) { }
