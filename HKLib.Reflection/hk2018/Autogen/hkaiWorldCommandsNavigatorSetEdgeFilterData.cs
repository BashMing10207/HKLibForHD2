...
internal class hkaiWorldCommandsNavigatorSetEdgeFilterData : HavokData<NavigatorSetEdgeFilter>
{
    public hkaiWorldCommandsNavigatorSetEdgeFilterData(HavokType type, NavigatorSetEdgeFilter instance) : base(type, instance) { }
