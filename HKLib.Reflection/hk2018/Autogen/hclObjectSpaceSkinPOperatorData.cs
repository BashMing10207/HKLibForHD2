...
internal class hclObjectSpaceSkinPOperatorData : HavokData<hclObjectSpaceSkinPOperator>
{
    public hclObjectSpaceSkinPOperatorData(HavokType type, hclObjectSpaceSkinPOperator instance) : base(type, instance) { }
