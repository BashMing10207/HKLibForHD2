...
internal class hkaiPhysicsBodyObstacleGeneratorData : HavokData<hkaiPhysicsBodyObstacleGenerator>
{
    public hkaiPhysicsBodyObstacleGeneratorData(HavokType type, hkaiPhysicsBodyObstacleGenerator instance) : base(type, instance) { }
