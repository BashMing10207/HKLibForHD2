...
internal class hkaiWorldCommandsNavigatorSetCharacterRadiusData : HavokData<NavigatorSetCharacterRadius>
{
    public hkaiWorldCommandsNavigatorSetCharacterRadiusData(HavokType type, NavigatorSetCharacterRadius instance) : base(type, instance) { }
