...
internal class hkaiWorldCommandsNavigatorSetTurningRadiusMultipliersData : HavokData<NavigatorSetTurningRadiusMultipliers>
{
    public hkaiWorldCommandsNavigatorSetTurningRadiusMultipliersData(HavokType type, NavigatorSetTurningRadiusMultipliers instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_leftMultiplier":
            case "leftMultiplier":
                {
                    if (instance.m_leftMultiplier is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_rightMultiplier":
            case "rightMultiplier":
                {
                    if (instance.m_rightMultiplier is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
            ...
            case "leftMultiplier":
                {
                    ...
                    instance.m_leftMultiplier = castValue;
                    return true;
                }
            case "m_rightMultiplier":
            case "rightMultiplier":
                {
                    if (value is not float castValue) return false;
                    instance.m_rightMultiplier = castValue;
                    return true;
                }
            default:
                return false;
