...
internal class hknpParticlesCollidedWithParticlesEventData : HavokData<hknpParticlesCollidedWithParticlesEvent>
{
    public hknpParticlesCollidedWithParticlesEventData(HavokType type, hknpParticlesCollidedWithParticlesEvent instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_particlesCollided":
            case "particlesCollided":
                {
                    if (instance.m_particlesCollided is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "particlesCollided":
                {
                    if (value is not ArraySegment<hknpParticleCollisionPair> castValue) return false;
                    instance.m_particlesCollided = castValue;
                    return true;
                }
            default:
                return false;
