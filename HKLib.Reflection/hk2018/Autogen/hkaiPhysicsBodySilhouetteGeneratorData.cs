...
internal class hkaiPhysicsBodySilhouetteGeneratorData : HavokData<hkaiPhysicsBodySilhouetteGenerator>
{
    public hkaiPhysicsBodySilhouetteGeneratorData(HavokType type, hkaiPhysicsBodySilhouetteGenerator instance) : base(type, instance) { }
