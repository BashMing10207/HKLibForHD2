...
internal class hkRangeRealAttributeData : HavokData<hkRangeRealAttribute>
{
    public hkRangeRealAttributeData(HavokType type, hkRangeRealAttribute instance) : base(type, instance) { }
