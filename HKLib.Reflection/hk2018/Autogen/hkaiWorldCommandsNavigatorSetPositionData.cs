...
internal class hkaiWorldCommandsNavigatorSetPositionData : HavokData<NavigatorSetPosition>
{
    public hkaiWorldCommandsNavigatorSetPositionData(HavokType type, NavigatorSetPosition instance) : base(type, instance) { }
