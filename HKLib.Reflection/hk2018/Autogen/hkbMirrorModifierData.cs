...
internal class hkbMirrorModifierData : HavokData<hkbMirrorModifier>
{
    public hkbMirrorModifierData(HavokType type, hkbMirrorModifier instance) : base(type, instance) { }
