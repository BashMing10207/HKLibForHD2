...
internal class hkbHandIkControlsModifierData : HavokData<hkbHandIkControlsModifier>
{
    public hkbHandIkControlsModifierData(HavokType type, hkbHandIkControlsModifier instance) : base(type, instance) { }
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "hands":
                {
                    if (value is not List<hkbHandIkControlsModifier.Hand> castValue) return false;
