...
internal class hknpRemoveParticlesCommandData : HavokData<hknpRemoveParticlesCommand>
{
    public hknpRemoveParticlesCommandData(HavokType type, hknpRemoveParticlesCommand instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_particlesToRemove":
            case "particlesToRemove":
                {
                    if (instance.m_particlesToRemove is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_movedCaches":
            case "movedCaches":
                {
                    if (instance.m_movedCaches is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "particlesToRemove":
                {
                    if (value is not ArraySegment<int> castValue) return false;
                    instance.m_particlesToRemove = castValue;
                    return true;
                }
            case "m_movedCaches":
            case "movedCaches":
                {
                    if (value is not List<hknpParticleCacheMoveInfo> castValue) return false;
                    instance.m_movedCaches = castValue;
                    return true;
                }
            default:
                return false;
