...
internal class hkaiWorldCommandsNavigatorRemoveData : HavokData<NavigatorRemove>
{
    public hkaiWorldCommandsNavigatorRemoveData(HavokType type, NavigatorRemove instance) : base(type, instance) { }
