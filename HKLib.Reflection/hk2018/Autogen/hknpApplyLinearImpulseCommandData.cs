...
internal class hknpApplyLinearImpulseCommandData : HavokData<hknpApplyLinearImpulseCommand>
{
    public hknpApplyLinearImpulseCommandData(HavokType type, hknpApplyLinearImpulseCommand instance) : base(type, instance) { }
