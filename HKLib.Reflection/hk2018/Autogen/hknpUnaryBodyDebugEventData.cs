...
internal class hknpUnaryBodyDebugEventData : HavokData<hknpUnaryBodyDebugEvent>
{
    public hknpUnaryBodyDebugEventData(HavokType type, hknpUnaryBodyDebugEvent instance) : base(type, instance) { }
