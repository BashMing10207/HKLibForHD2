...
internal class hknpSetWorldShapeTagCodecCommandData : HavokData<hknpSetWorldShapeTagCodecCommand>
{
    public hknpSetWorldShapeTagCodecCommandData(HavokType type, hknpSetWorldShapeTagCodecCommand instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "codec":
                {
                    if (instance.m_codec is null)
                    {
                        return true;
                    }
                    if (instance.m_codec is TGet castValue)
                    {
                        value = castValue;
                        return true;
                    }
            ...
            case "codec":
                {
                    if (value is null)
                    {
                        instance.m_codec = default;
                        return true;
                    }
                    if (value is hknpShapeTagCodec castValue)
                    {
                        instance.m_codec = castValue;
                        return true;
                    }
                    return false;
                }
