...
internal class hknpCylinderShapeData : HavokData<hknpCylinderShape>
{
    public hknpCylinderShapeData(HavokType type, hknpCylinderShape instance) : base(type, instance) { }
