...
internal class hkaiWorldCommandsVolumeNavigatorSetPositionData : HavokData<VolumeNavigatorSetPosition>
{
    public hkaiWorldCommandsVolumeNavigatorSetPositionData(HavokType type, VolumeNavigatorSetPosition instance) : base(type, instance) { }
