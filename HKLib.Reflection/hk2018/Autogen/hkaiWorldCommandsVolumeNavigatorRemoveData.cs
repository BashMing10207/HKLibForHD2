...
internal class hkaiWorldCommandsVolumeNavigatorRemoveData : HavokData<VolumeNavigatorRemove>
{
    public hkaiWorldCommandsVolumeNavigatorRemoveData(HavokType type, VolumeNavigatorRemove instance) : base(type, instance) { }
