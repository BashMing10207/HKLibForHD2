...
internal class hkaiNavigatorPathRequestData : HavokData<hkaiNavigator.PathRequest>
{
    public hkaiNavigatorPathRequestData(HavokType type, hkaiNavigator.PathRequest instance) : base(type, instance) { }
            ...
            case "pathRequestInput":
                {
                    ...
                    if (value is hkaiNavigator.PathRequestInput castValue)
                    {
