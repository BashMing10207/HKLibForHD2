...
internal class hknpDestroyConstraintsCommandData : HavokData<hknpDestroyConstraintsCommand>
{
    public hknpDestroyConstraintsCommandData(HavokType type, hknpDestroyConstraintsCommand instance) : base(type, instance) { }
