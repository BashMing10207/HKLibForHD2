...
internal class hknpClearBodyDragPropertiesCommandData : HavokData<hknpClearBodyDragPropertiesCommand>
{
    public hknpClearBodyDragPropertiesCommandData(HavokType type, hknpClearBodyDragPropertiesCommand instance) : base(type, instance) { }
