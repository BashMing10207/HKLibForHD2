...
internal class hkaiWorldCommandsSetDefaultPathfindingInputData : HavokData<SetDefaultPathfindingInput>
{
    public hkaiWorldCommandsSetDefaultPathfindingInputData(HavokType type, SetDefaultPathfindingInput instance) : base(type, instance) { }
