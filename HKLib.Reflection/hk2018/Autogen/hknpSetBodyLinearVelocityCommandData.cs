...
internal class hknpSetBodyLinearVelocityCommandData : HavokData<hknpSetBodyLinearVelocityCommand>
{
    public hknpSetBodyLinearVelocityCommandData(HavokType type, hknpSetBodyLinearVelocityCommand instance) : base(type, instance) { }
