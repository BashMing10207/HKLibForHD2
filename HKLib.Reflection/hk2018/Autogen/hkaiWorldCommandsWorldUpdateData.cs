...
internal class hkaiWorldCommandsWorldUpdateData : HavokData<WorldUpdate>
{
    public hkaiWorldCommandsWorldUpdateData(HavokType type, WorldUpdate instance) : base(type, instance) { }
