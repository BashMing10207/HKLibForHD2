...
internal class hknpAddParticlesCommandData : HavokData<hknpAddParticlesCommand>
{
    public hknpAddParticlesCommandData(HavokType type, hknpAddParticlesCommand instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "netChange":
                {
                    if (instance.m_netChange is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
            ...
            case "netChange":
                {
                    ...
                    instance.m_netChange = castValue;
                    return true;
                }
            default:
                return false;
