...
internal class hkaiWorldCommandsSetAvoidancePairPropertiesData : HavokData<SetAvoidancePairProperties>
{
    public hkaiWorldCommandsSetAvoidancePairPropertiesData(HavokType type, SetAvoidancePairProperties instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_avoidancePairProperties":
            case "avoidancePairProperties":
                {
                    if (instance.m_avoidancePairProperties is null)
                    {
                        return true;
                    }
                    if (instance.m_avoidancePairProperties is TGet castValue)
                    {
                        value = castValue;
                        return true;
                    }
            ...
            case "avoidancePairProperties":
                {
                    if (value is null)
                    {
                        instance.m_avoidancePairProperties = default;
                        return true;
                    }
                    if (value is hkaiAvoidancePairProperties castValue)
                    {
                        instance.m_avoidancePairProperties = castValue;
                        return true;
                    }
                    return false;
                }
