...
internal class hkaiCollisionAvoidanceDefaultBoundaryGathererData : HavokData<DefaultBoundaryGatherer>
{
    public hkaiCollisionAvoidanceDefaultBoundaryGathererData(HavokType type, DefaultBoundaryGatherer instance) : base(type, instance) { }
