...
internal class hclObjectSpaceSkinOperatorData : HavokData<hclObjectSpaceSkinOperator>
{
    public hclObjectSpaceSkinOperatorData(HavokType type, hclObjectSpaceSkinOperator instance) : base(type, instance) { }
