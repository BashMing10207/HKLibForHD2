...
internal class hknpAttachBodyCommandData : HavokData<hknpAttachBodyCommand>
{
    public hknpAttachBodyCommandData(HavokType type, hknpAttachBodyCommand instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_compoundBodyId":
            case "compoundBodyId":
                {
                    if (instance.m_compoundBodyId is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "compoundBodyId":
                {
                    if (value is not hknpBodyId castValue) return false;
                    instance.m_compoundBodyId = castValue;
                    return true;
                }
            case "m_updateMotionMode":
            case "updateMotionMode":
