...
internal class hkaiInvertedAabbVolumeData : HavokData<hkaiInvertedAabbVolume>
{
    public hkaiInvertedAabbVolumeData(HavokType type, hkaiInvertedAabbVolume instance) : base(type, instance) { }
