...
internal class hknpDisableParticlesCommandData : HavokData<hknpDisableParticlesCommand>
{
    public hknpDisableParticlesCommandData(HavokType type, hknpDisableParticlesCommand instance) : base(type, instance) { }
