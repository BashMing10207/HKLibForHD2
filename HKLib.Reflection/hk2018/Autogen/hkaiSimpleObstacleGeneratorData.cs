...
internal class hkaiSimpleObstacleGeneratorData : HavokData<hkaiSimpleObstacleGenerator>
{
    public hkaiSimpleObstacleGeneratorData(HavokType type, hkaiSimpleObstacleGenerator instance) : base(type, instance) { }
