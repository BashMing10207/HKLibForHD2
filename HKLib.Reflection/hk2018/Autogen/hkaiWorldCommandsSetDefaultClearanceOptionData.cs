...
internal class hkaiWorldCommandsSetDefaultClearanceOptionData : HavokData<SetDefaultClearanceOption>
{
    public hkaiWorldCommandsSetDefaultClearanceOptionData(HavokType type, SetDefaultClearanceOption instance) : base(type, instance) { }
