...
internal class hkbModifierWrapperData : HavokData<hkbModifierWrapper>
{
    public hkbModifierWrapperData(HavokType type, hkbModifierWrapper instance) : base(type, instance) { }
