...
internal class hkaiPointCloudSilhouetteGeneratorData : HavokData<hkaiPointCloudSilhouetteGenerator>
{
    public hkaiPointCloudSilhouetteGeneratorData(HavokType type, hkaiPointCloudSilhouetteGenerator instance) : base(type, instance) { }
