...
internal class hknpUnaryBodyApiCommandData : HavokData<hknpUnaryBodyApiCommand>
{
    public hknpUnaryBodyApiCommandData(HavokType type, hknpUnaryBodyApiCommand instance) : base(type, instance) { }
