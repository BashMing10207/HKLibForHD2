...
internal class hknpScaledConvexShapeData : HavokData<hknpScaledConvexShape>
{
    public hknpScaledConvexShapeData(HavokType type, hknpScaledConvexShape instance) : base(type, instance) { }
