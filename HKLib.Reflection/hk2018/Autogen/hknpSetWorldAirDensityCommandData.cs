...
internal class hknpSetWorldAirDensityCommandData : HavokData<hknpSetWorldAirDensityCommand>
{
    public hknpSetWorldAirDensityCommandData(HavokType type, hknpSetWorldAirDensityCommand instance) : base(type, instance) { }
