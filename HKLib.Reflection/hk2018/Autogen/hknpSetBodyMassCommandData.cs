...
internal class hknpSetBodyMassCommandData : HavokData<hknpSetBodyMassCommand>
{
    public hknpSetBodyMassCommandData(HavokType type, hknpSetBodyMassCommand instance) : base(type, instance) { }
