...
internal class hkaReferencePoseAnimationData : HavokData<hkaReferencePoseAnimation>
{
    public hkaReferencePoseAnimationData(HavokType type, hkaReferencePoseAnimation instance) : base(type, instance) { }
