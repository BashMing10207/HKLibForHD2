...
internal class hkaiWorldCommandsUnloadNavMeshInstanceData : HavokData<UnloadNavMeshInstance>
{
    public hkaiWorldCommandsUnloadNavMeshInstanceData(HavokType type, UnloadNavMeshInstance instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_unloadGraphInstance":
            case "unloadGraphInstance":
                {
                    if (instance.m_unloadGraphInstance is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
            ...
            case "unloadGraphInstance":
                {
                    ...
                    instance.m_unloadGraphInstance = castValue;
                    return true;
                }
            default:
                return false;
