...
internal class hknpSetEventDispatcherCommandData : HavokData<hknpSetEventDispatcherCommand>
{
    public hknpSetEventDispatcherCommandData(HavokType type, hknpSetEventDispatcherCommand instance) : base(type, instance) { }
