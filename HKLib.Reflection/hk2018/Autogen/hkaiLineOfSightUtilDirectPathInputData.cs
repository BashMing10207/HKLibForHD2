...
internal class hkaiLineOfSightUtilDirectPathInputData : HavokData<hkaiLineOfSightUtil.DirectPathInput>
{
    public hkaiLineOfSightUtilDirectPathInputData(HavokType type, hkaiLineOfSightUtil.DirectPathInput instance) : base(type, instance) { }
