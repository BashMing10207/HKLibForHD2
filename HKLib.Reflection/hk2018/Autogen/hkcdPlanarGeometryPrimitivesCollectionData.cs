...
internal class hkcdPlanarGeometryPrimitivesCollectionData : HavokData<Collection>
{
    private static readonly System.Reflection.FieldInfo _secondaryBitmapsInfo = typeof(Collection).GetField("m_secondaryBitmaps")!;
    private static readonly System.Reflection.FieldInfo _freeBlocksInfo = typeof(Collection).GetField("m_freeBlocks")!;
    public hkcdPlanarGeometryPrimitivesCollectionData(HavokType type, Collection instance) : base(type, instance) { }
