...
internal class hkaiWorldCommandsNavigatorSetLayerIndexData : HavokData<NavigatorSetLayerIndex>
{
    public hkaiWorldCommandsNavigatorSetLayerIndexData(HavokType type, NavigatorSetLayerIndex instance) : base(type, instance) { }
