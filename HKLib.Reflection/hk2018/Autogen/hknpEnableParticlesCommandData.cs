...
internal class hknpEnableParticlesCommandData : HavokData<hknpEnableParticlesCommand>
{
    public hknpEnableParticlesCommandData(HavokType type, hknpEnableParticlesCommand instance) : base(type, instance) { }
