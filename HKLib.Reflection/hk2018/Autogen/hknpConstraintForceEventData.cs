...
internal class hknpConstraintForceEventData : HavokData<hknpConstraintForceEvent>
{
    public hknpConstraintForceEventData(HavokType type, hknpConstraintForceEvent instance) : base(type, instance) { }
