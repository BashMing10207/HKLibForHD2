...
internal class hkbReferencePoseGeneratorData : HavokData<hkbReferencePoseGenerator>
{
    public hkbReferencePoseGeneratorData(HavokType type, hkbReferencePoseGenerator instance) : base(type, instance) { }
