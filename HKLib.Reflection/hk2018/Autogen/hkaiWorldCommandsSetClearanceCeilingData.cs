...
internal class hkaiWorldCommandsSetClearanceCeilingData : HavokData<SetClearanceCeiling>
{
    public hkaiWorldCommandsSetClearanceCeilingData(HavokType type, SetClearanceCeiling instance) : base(type, instance) { }
