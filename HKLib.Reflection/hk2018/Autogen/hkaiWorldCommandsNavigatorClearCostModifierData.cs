...
internal class hkaiWorldCommandsNavigatorClearCostModifierData : HavokData<NavigatorClearCostModifier>
{
    public hkaiWorldCommandsNavigatorClearCostModifierData(HavokType type, NavigatorClearCostModifier instance) : base(type, instance) { }
