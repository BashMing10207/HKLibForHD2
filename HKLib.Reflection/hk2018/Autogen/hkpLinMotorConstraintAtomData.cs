...
internal class hkpLinMotorConstraintAtomData : HavokData<hkpLinMotorConstraintAtom>
{
    public hkpLinMotorConstraintAtomData(HavokType type, hkpLinMotorConstraintAtom instance) : base(type, instance) { }
