...
internal class hknpVdbImmediateConstraintData : HavokData<hknpVdbImmediateConstraint>
{
    public hknpVdbImmediateConstraintData(HavokType type, hknpVdbImmediateConstraint instance) : base(type, instance) { }
