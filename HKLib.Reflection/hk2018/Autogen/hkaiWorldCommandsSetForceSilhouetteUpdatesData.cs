...
internal class hkaiWorldCommandsSetForceSilhouetteUpdatesData : HavokData<SetForceSilhouetteUpdates>
{
    public hkaiWorldCommandsSetForceSilhouetteUpdatesData(HavokType type, SetForceSilhouetteUpdates instance) : base(type, instance) { }
