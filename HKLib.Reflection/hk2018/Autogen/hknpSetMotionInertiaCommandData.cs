...
internal class hknpSetMotionInertiaCommandData : HavokData<hknpSetMotionInertiaCommand>
{
    public hknpSetMotionInertiaCommandData(HavokType type, hknpSetMotionInertiaCommand instance) : base(type, instance) { }
