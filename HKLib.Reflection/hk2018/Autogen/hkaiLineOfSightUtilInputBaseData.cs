...
internal class hkaiLineOfSightUtilInputBaseData : HavokData<hkaiLineOfSightUtil.InputBase>
{
    public hkaiLineOfSightUtilInputBaseData(HavokType type, hkaiLineOfSightUtil.InputBase instance) : base(type, instance) { }
