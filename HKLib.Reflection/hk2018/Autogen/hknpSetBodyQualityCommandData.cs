...
internal class hknpSetBodyQualityCommandData : HavokData<hknpSetBodyQualityCommand>
{
    public hknpSetBodyQualityCommandData(HavokType type, hknpSetBodyQualityCommand instance) : base(type, instance) { }
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "qualityId":
                {
                    if (value is not hknpBodyQualityId castValue) return false;
