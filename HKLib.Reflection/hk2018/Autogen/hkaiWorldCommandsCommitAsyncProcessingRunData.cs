...
internal class hkaiWorldCommandsCommitAsyncProcessingRunData : HavokData<CommitAsyncProcessingRun>
{
    public hkaiWorldCommandsCommitAsyncProcessingRunData(HavokType type, CommitAsyncProcessingRun instance) : base(type, instance) { }
