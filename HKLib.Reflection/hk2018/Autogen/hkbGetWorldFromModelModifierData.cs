...
internal class hkbGetWorldFromModelModifierData : HavokData<hkbGetWorldFromModelModifier>
{
    public hkbGetWorldFromModelModifierData(HavokType type, hkbGetWorldFromModelModifier instance) : base(type, instance) { }
