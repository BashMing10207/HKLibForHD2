...
internal class hknpManifoldViewerBaseManifoldWeldingEventData : HavokData<ManifoldWeldingEvent>
{
    private static readonly System.Reflection.FieldInfo _bodyIdsInfo = typeof(ManifoldWeldingEvent).GetField("m_bodyIds")!;
    private static readonly System.Reflection.FieldInfo _shapeKeysInfo = typeof(ManifoldWeldingEvent).GetField("m_shapeKeys")!;
    public hknpManifoldViewerBaseManifoldWeldingEventData(HavokType type, ManifoldWeldingEvent instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_weldingStatus":
            case "weldingStatus":
                {
                    if (instance.m_weldingStatus is TGet castValue)
                    {
                        value = castValue;
                        return true;
                    }
                    if ((byte)instance.m_weldingStatus is TGet byteValue)
                    {
                        value = byteValue;
                        return true;
                    }
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "weldingStatus":
                {
                    if (value is ManifoldWeldingEvent.WeldingStatusEnum castValue)
                    {
                        instance.m_weldingStatus = castValue;
                        return true;
                    }
                    if (value is byte byteValue)
                    {
                        instance.m_weldingStatus = (ManifoldWeldingEvent.WeldingStatusEnum)byteValue;
                        return true;
                    }
                    return false;
                }
