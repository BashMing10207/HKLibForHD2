...
internal class hkaiPathfindingUtilFindPathInputData : HavokData<FindPathInput>
{
    public hkaiPathfindingUtilFindPathInputData(HavokType type, FindPathInput instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "goalFaceKeys":
                {
                    if (instance.m_goalFaceKeys is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            ...
            case "goalFaceKeys":
                {
                    ...
                    instance.m_goalFaceKeys = castValue;
                    return true;
                }
            case "m_maxNumberOfIterations":
            case "maxNumberOfIterations":
