...
internal class hkbBehaviorEventsInfoData : HavokData<hkbBehaviorEventsInfo>
{
    public hkbBehaviorEventsInfoData(HavokType type, hkbBehaviorEventsInfo instance) : base(type, instance) { }
