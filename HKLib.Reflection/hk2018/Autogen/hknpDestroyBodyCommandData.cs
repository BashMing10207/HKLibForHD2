...
internal class hknpDestroyBodyCommandData : HavokData<hknpDestroyBodyCommand>
{
    public hknpDestroyBodyCommandData(HavokType type, hknpDestroyBodyCommand instance) : base(type, instance) { }
