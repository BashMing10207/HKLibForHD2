...
internal class hknpShiftBroadphaseCommandData : HavokData<hknpShiftBroadphaseCommand>
{
    public hknpShiftBroadphaseCommandData(HavokType type, hknpShiftBroadphaseCommand instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_requestedCenterPos":
            case "requestedCenterPos":
                {
                    if (instance.m_requestedCenterPos is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
            ...
            case "requestedCenterPos":
                {
                    ...
                    instance.m_requestedCenterPos = castValue;
                    return true;
                }
            default:
                return false;
