...
internal class hkbDelayedModifierData : HavokData<hkbDelayedModifier>
{
    public hkbDelayedModifierData(HavokType type, hkbDelayedModifier instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "delaySeconds":
                {
                    if (instance.m_delaySeconds is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_durationSeconds":
            case "durationSeconds":
                {
                    if (instance.m_durationSeconds is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
            ...
            case "delaySeconds":
                {
                    ...
                    instance.m_delaySeconds = castValue;
                    return true;
                }
            case "m_durationSeconds":
            case "durationSeconds":
                {
                    if (value is not float castValue) return false;
                    instance.m_durationSeconds = castValue;
                    return true;
                }
            default:
                return false;
