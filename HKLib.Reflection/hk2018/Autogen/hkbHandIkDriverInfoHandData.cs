...
internal class hkbHandIkDriverInfoHandData : HavokData<hkbHandIkDriverInfo.Hand>
{
    public hkbHandIkDriverInfoHandData(HavokType type, hkbHandIkDriverInfo.Hand instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_handOrienationOffsetLS":
            case "handOrienationOffsetLS":
                {
                    if (instance.m_handOrienationOffsetLS is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            ...
            case "handOrienationOffsetLS":
                {
                    ...
                    instance.m_handOrienationOffsetLS = castValue;
                    return true;
                }
            case "m_maxElbowAngleDegrees":
            case "maxElbowAngleDegrees":
