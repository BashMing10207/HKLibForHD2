...
internal class hkaiWorldCommandsLoadNavMeshGraphData : HavokData<LoadNavMeshGraph>
{
    public hkaiWorldCommandsLoadNavMeshGraphData(HavokType type, LoadNavMeshGraph instance) : base(type, instance) { }
