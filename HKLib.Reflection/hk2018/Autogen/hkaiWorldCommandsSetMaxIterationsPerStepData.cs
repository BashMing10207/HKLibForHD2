...
internal class hkaiWorldCommandsSetMaxIterationsPerStepData : HavokData<SetMaxIterationsPerStep>
{
    public hkaiWorldCommandsSetMaxIterationsPerStepData(HavokType type, SetMaxIterationsPerStep instance) : base(type, instance) { }
