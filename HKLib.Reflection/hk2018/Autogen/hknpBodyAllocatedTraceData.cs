...
internal class hknpBodyAllocatedTraceData : HavokData<hknpBodyAllocatedTrace>
{
    public hknpBodyAllocatedTraceData(HavokType type, hknpBodyAllocatedTrace instance) : base(type, instance) { }
