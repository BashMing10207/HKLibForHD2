...
internal class hknpShiftWorldCommandData : HavokData<hknpShiftWorldCommand>
{
    public hknpShiftWorldCommandData(HavokType type, hknpShiftWorldCommand instance) : base(type, instance) { }
