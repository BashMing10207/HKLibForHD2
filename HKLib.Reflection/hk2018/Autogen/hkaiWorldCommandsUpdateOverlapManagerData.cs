...
internal class hkaiWorldCommandsUpdateOverlapManagerData : HavokData<UpdateOverlapManager>
{
    public hkaiWorldCommandsUpdateOverlapManagerData(HavokType type, UpdateOverlapManager instance) : base(type, instance) { }
