...
internal class hkaiWorldCommandsSetPerformValidationChecksData : HavokData<SetPerformValidationChecks>
{
    public hkaiWorldCommandsSetPerformValidationChecksData(HavokType type, SetPerformValidationChecks instance) : base(type, instance) { }
