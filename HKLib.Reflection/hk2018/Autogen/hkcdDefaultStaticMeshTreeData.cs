...
internal class hkcdDefaultStaticMeshTreeData : HavokData<hkcdDefaultStaticMeshTree>
{
    public hkcdDefaultStaticMeshTreeData(HavokType type, hkcdDefaultStaticMeshTree instance) : base(type, instance) { }
