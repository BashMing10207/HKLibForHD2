...
internal class hknpLinearIntegrationClippedEventData : HavokData<hknpLinearIntegrationClippedEvent>
{
    public hknpLinearIntegrationClippedEventData(HavokType type, hknpLinearIntegrationClippedEvent instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_stolenVelocity":
            case "stolenVelocity":
                {
                    if (instance.m_stolenVelocity is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
            ...
            case "stolenVelocity":
                {
                    ...
                    instance.m_stolenVelocity = castValue;
                    return true;
                }
            default:
                return false;
