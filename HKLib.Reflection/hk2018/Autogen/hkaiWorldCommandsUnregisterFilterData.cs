...
internal class hkaiWorldCommandsUnregisterFilterData : HavokData<UnregisterFilter>
{
    public hkaiWorldCommandsUnregisterFilterData(HavokType type, UnregisterFilter instance) : base(type, instance) { }
