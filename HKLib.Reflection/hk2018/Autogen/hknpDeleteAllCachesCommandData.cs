...
internal class hknpDeleteAllCachesCommandData : HavokData<hknpDeleteAllCachesCommand>
{
    public hknpDeleteAllCachesCommandData(HavokType type, hknpDeleteAllCachesCommand instance) : base(type, instance) { }
