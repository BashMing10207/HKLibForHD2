...
internal class hknpBinaryBodyEventData : HavokData<hknpBinaryBodyEvent>
{
    private static readonly System.Reflection.FieldInfo _bodyIdsInfo = typeof(hknpBinaryBodyEvent).GetField("m_bodyIds")!;
    public hknpBinaryBodyEventData(HavokType type, hknpBinaryBodyEvent instance) : base(type, instance) { }
