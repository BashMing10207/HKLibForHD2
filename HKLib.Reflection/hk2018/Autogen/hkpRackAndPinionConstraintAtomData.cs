...
internal class hkpRackAndPinionConstraintAtomData : HavokData<hkpRackAndPinionConstraintAtom>
{
    public hkpRackAndPinionConstraintAtomData(HavokType type, hkpRackAndPinionConstraintAtom instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_pinionRadiusOrScrewPitch":
            case "pinionRadiusOrScrewPitch":
                {
                    if (instance.m_pinionRadiusOrScrewPitch is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_isScrew":
            ...
            case "pinionRadiusOrScrewPitch":
                {
                    ...
                    instance.m_pinionRadiusOrScrewPitch = castValue;
                    return true;
                }
            case "m_isScrew":
            case "isScrew":
