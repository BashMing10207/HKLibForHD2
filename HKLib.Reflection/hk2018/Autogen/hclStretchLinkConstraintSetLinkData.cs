...
internal class hclStretchLinkConstraintSetLinkData : HavokData<hclStretchLinkConstraintSet.Link>
{
    public hclStretchLinkConstraintSetLinkData(HavokType type, hclStretchLinkConstraintSet.Link instance) : base(type, instance) { }
