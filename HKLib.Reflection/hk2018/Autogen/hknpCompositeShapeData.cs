...
internal class hknpCompositeShapeData : HavokData<hknpCompositeShape>
{
    public hknpCompositeShapeData(HavokType type, hknpCompositeShape instance) : base(type, instance) { }
