...
internal class TestComplexRecordData : HavokData<TestComplexRecord>
{
    public TestComplexRecordData(HavokType type, TestComplexRecord instance) : base(type, instance) { }
