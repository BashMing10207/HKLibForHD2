...
internal class hknpRebuildParticleCollisionCachesCommandData : HavokData<hknpRebuildParticleCollisionCachesCommand>
{
    public hknpRebuildParticleCollisionCachesCommandData(HavokType type, hknpRebuildParticleCollisionCachesCommand instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "numToRebuild":
                {
                    if (instance.m_numToRebuild is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "numToRebuild":
                {
                    if (value is not int castValue) return false;
                    instance.m_numToRebuild = castValue;
                    return true;
                }
            default:
                return false;
