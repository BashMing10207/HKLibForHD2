...
internal class hknpUnaryBodyEventData : HavokData<hknpUnaryBodyEvent>
{
    public hknpUnaryBodyEventData(HavokType type, hknpUnaryBodyEvent instance) : base(type, instance) { }
