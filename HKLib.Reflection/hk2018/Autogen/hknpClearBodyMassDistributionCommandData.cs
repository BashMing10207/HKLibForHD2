...
internal class hknpClearBodyMassDistributionCommandData : HavokData<hknpClearBodyMassDistributionCommand>
{
    public hknpClearBodyMassDistributionCommandData(HavokType type, hknpClearBodyMassDistributionCommand instance) : base(type, instance) { }
