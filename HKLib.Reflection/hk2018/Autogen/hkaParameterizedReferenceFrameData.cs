...
internal class hkaParameterizedReferenceFrameData : HavokData<hkaParameterizedReferenceFrame>
{
    public hkaParameterizedReferenceFrameData(HavokType type, hkaParameterizedReferenceFrame instance) : base(type, instance) { }
