...
internal class hknpDetachBodyCommandData : HavokData<hknpDetachBodyCommand>
{
    public hknpDetachBodyCommandData(HavokType type, hknpDetachBodyCommand instance) : base(type, instance) { }
