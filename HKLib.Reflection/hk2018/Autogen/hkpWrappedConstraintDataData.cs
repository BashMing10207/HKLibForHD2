...
internal class hkpWrappedConstraintDataData : HavokData<hkpWrappedConstraintData>
{
    public hkpWrappedConstraintDataData(HavokType type, hkpWrappedConstraintData instance) : base(type, instance) { }
