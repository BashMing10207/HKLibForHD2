...
internal class hkMeshSectionData : HavokData<hkMeshSection>
{
    public hkMeshSectionData(HavokType type, hkMeshSection instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "boneMatrixMap":
                {
                    if (instance.m_boneMatrixMap is null)
                    {
                        return true;
                    }
                    if (instance.m_boneMatrixMap is TGet castValue)
                    {
                        value = castValue;
                        return true;
                    }
            ...
            case "boneMatrixMap":
                {
                    if (value is null)
                    {
                        instance.m_boneMatrixMap = default;
                        return true;
                    }
                    if (value is hkMeshBoneIndexMapping castValue)
                    {
