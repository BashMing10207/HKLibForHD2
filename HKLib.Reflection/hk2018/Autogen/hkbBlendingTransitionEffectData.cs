...
internal class hkbBlendingTransitionEffectData : HavokData<hkbBlendingTransitionEffect>
{
    public hkbBlendingTransitionEffectData(HavokType type, hkbBlendingTransitionEffect instance) : base(type, instance) { }
