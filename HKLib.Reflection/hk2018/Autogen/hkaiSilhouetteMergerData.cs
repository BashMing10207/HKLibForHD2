...
internal class hkaiSilhouetteMergerData : HavokData<hkaiSilhouetteMerger>
{
    public hkaiSilhouetteMergerData(HavokType type, hkaiSilhouetteMerger instance) : base(type, instance) { }
