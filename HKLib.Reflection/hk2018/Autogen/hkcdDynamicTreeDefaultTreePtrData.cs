...
internal class hkcdDynamicTreeDefaultTreePtrData : HavokData<DefaultTreePtr>
{
    public hkcdDynamicTreeDefaultTreePtrData(HavokType type, DefaultTreePtr instance) : base(type, instance) { }
