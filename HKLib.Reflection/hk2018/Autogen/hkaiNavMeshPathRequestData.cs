...
internal class hkaiNavMeshPathRequestData : HavokData<hkaiNavMeshPathRequest>
{
    public hkaiNavMeshPathRequestData(HavokType type, hkaiNavMeshPathRequest instance) : base(type, instance) { }
