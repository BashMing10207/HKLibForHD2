...
internal class hknpScaledConvexShapeBaseData : HavokData<hknpScaledConvexShapeBase>
{
    public hknpScaledConvexShapeBaseData(HavokType type, hknpScaledConvexShapeBase instance) : base(type, instance) { }
