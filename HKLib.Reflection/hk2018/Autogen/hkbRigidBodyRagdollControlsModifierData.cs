...
internal class hkbRigidBodyRagdollControlsModifierData : HavokData<hkbRigidBodyRagdollControlsModifier>
{
    public hkbRigidBodyRagdollControlsModifierData(HavokType type, hkbRigidBodyRagdollControlsModifier instance) : base(type, instance) { }
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "controlData":
                {
                    if (value is not hkbRigidBodyRagdollControlData castValue) return false;
