...
internal class hkaiWorldCommandsRemoveSilhouetteGeneratorData : HavokData<RemoveSilhouetteGenerator>
{
    public hkaiWorldCommandsRemoveSilhouetteGeneratorData(HavokType type, RemoveSilhouetteGenerator instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_silhouetteGenerator":
            case "silhouetteGenerator":
                {
                    if (instance.m_silhouetteGenerator is null)
                    {
                        return true;
                    }
                    if (instance.m_silhouetteGenerator is TGet castValue)
                    {
                        value = castValue;
                        return true;
                    }
            ...
            case "silhouetteGenerator":
                {
                    if (value is null)
                    {
                        instance.m_silhouetteGenerator = default;
                        return true;
                    }
                    if (value is hkaiSilhouetteGenerator castValue)
                    {
                        instance.m_silhouetteGenerator = castValue;
                        return true;
                    }
                    return false;
                }
