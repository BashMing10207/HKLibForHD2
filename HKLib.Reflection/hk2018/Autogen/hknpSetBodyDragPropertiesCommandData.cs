...
internal class hknpSetBodyDragPropertiesCommandData : HavokData<hknpSetBodyDragPropertiesCommand>
{
    public hknpSetBodyDragPropertiesCommandData(HavokType type, hknpSetBodyDragPropertiesCommand instance) : base(type, instance) { }
