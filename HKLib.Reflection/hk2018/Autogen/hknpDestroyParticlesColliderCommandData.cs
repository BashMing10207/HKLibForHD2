...
internal class hknpDestroyParticlesColliderCommandData : HavokData<hknpDestroyParticlesColliderCommand>
{
    public hknpDestroyParticlesColliderCommandData(HavokType type, hknpDestroyParticlesColliderCommand instance) : base(type, instance) { }
