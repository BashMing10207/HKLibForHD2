...
internal class hkExposeAsFlagsData : HavokData<ExposeAsFlags>
{
    public hkExposeAsFlagsData(HavokType type, ExposeAsFlags instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "listKeys":
                {
                    if (instance.m_listKeys is null)
                    {
                        return true;
                    }
                    if (instance.m_listKeys is TGet castValue)
                    {
                        value = castValue;
                        return true;
                    }
            ...
            case "cacheKey":
                {
                    if (instance.m_cacheKey is null)
                    {
                        return true;
                    }
                    if (instance.m_cacheKey is TGet castValue)
                    {
                        value = castValue;
                        return true;
                    }
            ...
            case "listKeys":
                {
                    if (value is null)
                    {
                        instance.m_listKeys = default;
                        return true;
                    }
                    if (value is object castValue)
                    {
                        instance.m_listKeys = castValue;
                        return true;
                    }
                    return false;
                }
            ...
            case "cacheKey":
                {
                    if (value is null)
                    {
                        instance.m_cacheKey = default;
                        return true;
                    }
                    if (value is object castValue)
                    {
                        instance.m_cacheKey = castValue;
                        return true;
                    }
                    return false;
                }
