...
internal class hkaiWorldCommandsNavigatorRepathImmediateData : HavokData<NavigatorRepathImmediate>
{
    public hkaiWorldCommandsNavigatorRepathImmediateData(HavokType type, NavigatorRepathImmediate instance) : base(type, instance) { }
