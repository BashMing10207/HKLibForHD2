...
internal class hclOutputConvertOperatorData : HavokData<hclOutputConvertOperator>
{
    public hclOutputConvertOperatorData(HavokType type, hclOutputConvertOperator instance) : base(type, instance) { }
