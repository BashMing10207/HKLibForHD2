...
internal class hclStandardLinkConstraintSetLinkData : HavokData<hclStandardLinkConstraintSet.Link>
{
    public hclStandardLinkConstraintSetLinkData(HavokType type, hclStandardLinkConstraintSet.Link instance) : base(type, instance) { }
