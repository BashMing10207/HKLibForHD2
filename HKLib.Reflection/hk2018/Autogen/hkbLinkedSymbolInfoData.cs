...
internal class hkbLinkedSymbolInfoData : HavokData<hkbLinkedSymbolInfo>
{
    public hkbLinkedSymbolInfoData(HavokType type, hkbLinkedSymbolInfo instance) : base(type, instance) { }
