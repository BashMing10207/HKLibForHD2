...
internal class hkbModifierListData : HavokData<hkbModifierList>
{
    public hkbModifierListData(HavokType type, hkbModifierList instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "modifiers":
                {
                    if (instance.m_modifiers is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
            ...
            case "modifiers":
                {
                    ...
                    instance.m_modifiers = castValue;
                    return true;
                }
            default:
                return false;
