...
internal class hkaiWorldCommandsRemoveObstacleGeneratorData : HavokData<RemoveObstacleGenerator>
{
    public hkaiWorldCommandsRemoveObstacleGeneratorData(HavokType type, RemoveObstacleGenerator instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_obstacleGenerator":
            case "obstacleGenerator":
                {
                    if (instance.m_obstacleGenerator is null)
                    {
                        return true;
                    }
                    if (instance.m_obstacleGenerator is TGet castValue)
                    {
                        value = castValue;
                        return true;
                    }
            ...
            case "obstacleGenerator":
                {
                    if (value is null)
                    {
                        instance.m_obstacleGenerator = default;
                        return true;
                    }
                    if (value is hkaiObstacleGenerator castValue)
                    {
                        instance.m_obstacleGenerator = castValue;
                        return true;
                    }
                    return false;
                }
