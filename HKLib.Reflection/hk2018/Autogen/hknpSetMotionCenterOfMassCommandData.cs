...
internal class hknpSetMotionCenterOfMassCommandData : HavokData<hknpSetMotionCenterOfMassCommand>
{
    public hknpSetMotionCenterOfMassCommandData(HavokType type, hknpSetMotionCenterOfMassCommand instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "com":
                {
                    if (instance.m_com is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
