...
internal class hknpParticlesColliderShapeData : HavokData<hknpParticlesColliderShape>
{
    public hknpParticlesColliderShapeData(HavokType type, hknpParticlesColliderShape instance) : base(type, instance) { }
