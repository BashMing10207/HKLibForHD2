...
internal class hknpSetBodyMotionCommandData : HavokData<hknpSetBodyMotionCommand>
{
    public hknpSetBodyMotionCommandData(HavokType type, hknpSetBodyMotionCommand instance) : base(type, instance) { }
