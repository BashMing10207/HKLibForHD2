...
internal class hknpStepCollideTraceData : HavokData<hknpStepCollideTrace>
{
    public hknpStepCollideTraceData(HavokType type, hknpStepCollideTrace instance) : base(type, instance) { }
