...
internal class hkaiWorldCommandsEnableAsyncProcessingData : HavokData<EnableAsyncProcessing>
{
    public hkaiWorldCommandsEnableAsyncProcessingData(HavokType type, EnableAsyncProcessing instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "m_asyncThreadPoolCinfo":
            case "asyncThreadPoolCinfo":
                {
                    if (instance.m_asyncThreadPoolCinfo is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            case "m_automaticStepping":
            case "automaticStepping":
                {
                    if (instance.m_automaticStepping is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
            default:
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "asyncThreadPoolCinfo":
                {
                    if (value is not Cinfo castValue) return false;
                    instance.m_asyncThreadPoolCinfo = castValue;
                    return true;
                }
            case "m_automaticStepping":
            case "automaticStepping":
                {
                    ...
                    instance.m_automaticStepping = castValue;
                    return true;
                }
            default:
                return false;
