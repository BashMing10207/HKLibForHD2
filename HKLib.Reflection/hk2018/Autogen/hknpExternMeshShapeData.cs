...
internal class hknpExternMeshShapeData : HavokData<hknpExternMeshShape>
{
    public hknpExternMeshShapeData(HavokType type, hknpExternMeshShape instance) : base(type, instance) { }
            ...
            case "geometry":
                {
                    ...
                    if (value is hknpExternMeshShapeGeometry castValue)
                    {
