...
internal class hkaiObstacleGeneratorData : HavokData<hkaiObstacleGenerator>
{
    public hkaiObstacleGeneratorData(HavokType type, hkaiObstacleGenerator instance) : base(type, instance) { }
