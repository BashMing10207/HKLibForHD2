...
internal class hclGatherSomeVerticesOperatorData : HavokData<hclGatherSomeVerticesOperator>
{
    public hclGatherSomeVerticesOperatorData(HavokType type, hclGatherSomeVerticesOperator instance) : base(type, instance) { }
    ...
    public override bool TryGetField<TGet>(string fieldName, [MaybeNull] out TGet value)
    {
        ...
        switch (fieldName)
        {
            ...
            case "vertexPairs":
                {
                    if (instance.m_vertexPairs is not TGet castValue) return false;
                    value = castValue;
                    return true;
                }
    ...
    public override bool TrySetField<TSet>(string fieldName, TSet value)
    {
        switch (fieldName)
        {
            ...
            case "vertexPairs":
                {
                    if (value is not List<hclGatherSomeVerticesOperator.VertexPair> castValue) return false;
                    instance.m_vertexPairs = castValue;
                    return true;
                }
            case "m_inputBufferIdx":
            case "inputBufferIdx":
