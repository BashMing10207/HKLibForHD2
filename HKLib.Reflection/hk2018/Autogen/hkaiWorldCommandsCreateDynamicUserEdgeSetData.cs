...
internal class hkaiWorldCommandsCreateDynamicUserEdgeSetData : HavokData<CreateDynamicUserEdgeSet>
{
    public hkaiWorldCommandsCreateDynamicUserEdgeSetData(HavokType type, CreateDynamicUserEdgeSet instance) : base(type, instance) { }
