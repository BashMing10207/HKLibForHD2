...
internal class hknpDecoratorShapeData : HavokData<hknpDecoratorShape>
{
    public hknpDecoratorShapeData(HavokType type, hknpDecoratorShape instance) : base(type, instance) { }
