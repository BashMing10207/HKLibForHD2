...
internal class hkaiWorldCommandsSetMaxRequestsPerStepData : HavokData<SetMaxRequestsPerStep>
{
    public hkaiWorldCommandsSetMaxRequestsPerStepData(HavokType type, SetMaxRequestsPerStep instance) : base(type, instance) { }
